...
class CampaignRoutesSpec extends AnyWordSpec with Matchers with ScalaFutures with ScalatestRouteTest {
  ...
  "be able to bid campaign successfully" in {
    ...
    entityAs[String] should === ("""{"adid":"2","banner":{"height":250,"id":1,"src":"https://business.eskimi.com/wp-content/uploads/2020/06/openGraph.jpeg","width":300},"bidRequestId":"SGu1Jpq1IO","id":"1799671509","price":3.12123}""")
    }
  ...
  "device geo should get higher priority that user geo " in {
    ...
    request ~> routes ~> check {
      ...
      contentType should === (ContentTypes.`application/json`)
      entityAs[String] should === ("""{"adid":"1000","banner":{"height":250,"id":2,"src":"https://business.eskimi.com/wp-content/uploads/2020/06/CHN.jpeg","width":300},"bidRequestId":"SGu1Jpq1IO","id":"1800458939","price":3.12123}""")
    }
